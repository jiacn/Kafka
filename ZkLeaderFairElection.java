...
public class ZkLeaderFairElection implements Watcher {
    ...
    public ZkLeaderFairElection(ZooKeeper zooKeeper, String rootPath, ElectionCallback callback) {
    ...
    public ZkLeaderFairElection(String connectString, int sessionTimeout, String rootPath, ElectionCallback callback) {
        this.rootPath = rootPath;
        this.callback = callback;
    ...
    private boolean leaderElection(boolean isWatchHandler) throws KeeperException, InterruptedException {
        ...
        NodeInfo minNodeInfo = childNodeInfo.get(0); //排序后，第一个最小的节点
